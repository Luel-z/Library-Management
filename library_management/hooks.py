...
app_publisher = "Luel Fekadu"
app_description = "simple library management system with custom API"
app_email = "luel.z.88@gmail.com"
app_license = "mit"
...
def custom_redirect():
    ...
    if not frappe.session.user or frappe.session.user == "Guest":
        ...
        frappe.local.response["location"] = "/books"

app_include_hooks = {
    "before_request": custom_redirect
}
